...
const conversation: LocaleDictOf<"conversation"> = {
  ...
  "access.confirm.title": "フールアクセスを有効にしますか？",
  "access.confirm.description":
    "フールアクセスを有効にすると、エージェントの確認ステップが減り、機密操作、ファイル変更、外部コマンドを含むより多くの操作を直接実行できるようになります。現在のタスクを信頼できる場合にのみ使用してください。",
  "access.confirm.acknowledge": "リスクを理解した上で続行します",
  "access.confirm.cancel": "キャンセル",
  "access.confirm.enable": "フールアクセスを有効化",
...
const settingsPermission: LocaleDictOf<"settings.permission"> = {
  ...
  loading: "読み込み中",
  unavailable: "利用不可",
  "confirm.title": "フールアクセスを有効にしますか？",
  "confirm.description":
    "フールアクセスを有効にすると、新しいセッションでの確認ステップが減り、機密操作、ファイル変更、外部コマンドを含むより多くの操作を直接実行できるようになります。以降のタスクを信頼できる場合にのみ使用してください。",
  "confirm.acknowledge": "リスクを理解した上で続行します",
  "confirm.cancel": "キャンセル",
  "confirm.enable": "フールアクセスを有効化",
};
...
const settingsPlugins: LocaleDictOf<"settings.plugins"> = {
  ...
  agentLoopDescription: "エージェントがツール呼び出しを振り分ける方法。",
